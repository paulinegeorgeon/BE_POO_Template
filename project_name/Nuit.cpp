...
void Nuit::tourBarman() { 
  ...
  int numJoueur = jeuRef.getRole("Barman"); 
...
void Nuit::tourGratteur() {
  ...
  int numJoueur1 = jeuRef.getRole("Gratteur Verre 1"); 
  int numJoueur2 = jeuRef.getRole("Gratteur Verre 2"); 

  //regarde si les deux gratteurs de verts sont morts
  if (!(jeuRef.getJoueur(numJoueur1)->getEstMort()) or !(jeuRef.getJoueur(numJoueur1)->getEstMort())){ 
    sonRef.playSong(8);
...
void Nuit::tourProtege() {
  int numJoueur = jeuRef.getRole("Protège Verre"); 

  //regarde si le protege vert est mort
  if (!(jeuRef.getJoueur(numJoueur)->getEstMort())){ 
...
void Nuit::tourMaladroit() {
  int numJoueur = jeuRef.getRole("Maladroit"); 

  //regarde si le maladroit est mort
  if (!(jeuRef.getJoueur(numJoueur)->getEstMort())){ 
...
void Nuit::tourEthylotest() {
  int numJoueur = jeuRef.getRole("Ethylotest"); 

  //regarde si le l'ethylotest est mort
  if (!(jeuRef.getJoueur(numJoueur)->getEstMort())){ 
